...
# Add main heading
heading_label = tk.Label(root, text="3 Products\n3 Constraints", font=("Times New Roman", 30, "bold"), justify="center", fg="white", bg="black")
heading_label.grid(row=0, column=0, columnspan=10, padx=10, pady=10)

# Add labels and entry widgets for inputs
tk.Label(root, text="Objective Function Coefficients", bg="black", fg="white").grid(row=1, column=0, columnspan=6)
...
tk.Label(root, text="Constraints", bg="black", fg="white").grid(row=3, column=0, columnspan=6)
